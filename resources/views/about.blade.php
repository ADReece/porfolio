...
<head>
    ...
    <title>About - PortfolioHub</title>
    ...
    <div class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h1 class="text-5xl font-bold text-gray-900 dark:text-white mb-4">About PortfolioHub</h1>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
                ...
                <p class="text-lg text-gray-700 dark:text-gray-300 mb-4">
                    At PortfolioHub, we believe that every photographer and videographer deserves a professional platform to showcase their work and grow their business. Our mission is to provide beautiful, easy-to-use tools that help creative professionals present their work in the best possible light and connect with clients seamlessly.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
                ...
                <p class="text-lg text-gray-700">
                    That's why we created PortfolioHub - a platform that combines stunning portfolio templates, private client galleries, watermarking, and integrated payment processing, all at an affordable price.
                </p>
            </div>
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-lg p-8 text-white text-center">
                ...
                <p class="text-lg mb-6">Start showcasing your work today with PortfolioHub</p>
